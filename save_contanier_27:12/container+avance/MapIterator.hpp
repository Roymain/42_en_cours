	...
	template <class T, class Compare, typename Node>
		class MapIterator{
			...
			MapIterator(const MapIterator<W, Comp, Nod> &copy){
				...
				_nodePtr->left = (Node*)(copy.getNodePtr()->left);
				_nodePtr->parent = (Node*)(copy.getNodePtr()->parent);
				_nodePtr->last = (Node*)(copy.getNodePtr()->last);
			...
			/* ------------------------------------------------------------- */
			/* --------------------- BOOL OPERATOR ------------------------- */
			// bool operator==(const map_iterator &it)const { return (it._nodePtr == _nodePtr);}
			// bool operator!=(const map_iterator &it)const { return (it._nodePtr != _nodePtr);}
			// bool operator <(const map_iterator &it)const { return (it._nodePtr > _nodePtr);}
			// bool operator >(const map_iterator &it)const { return (it._nodePtr < _nodePtr);}
			// bool operator <=(const map_iterator &it)const { return (it._nodePtr >= _nodePtr);}
