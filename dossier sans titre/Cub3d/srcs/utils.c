...
/*   Updated: 2022/09/12 19:50:14 by rcuminal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_imagesparttwo(t_cub *cub)
{
	cub->texture[1].img = mlx_xpm_file_to_image(cub->mlx, \
		"wall_2.xpm", &cub->texture[1].Widt, &cub->texture[1].Heig);
	...
	cub->texture[2].img = mlx_xpm_file_to_image(cub->mlx, "wall_3.xpm", \
	...
	cub->texture[2].arr = ft_mem2array((uint32_t *)cub->texture[2].addr, \
		cub->texture[2].Widt, cub->texture[2].Heig);
	cub->texture[3].img = mlx_xpm_file_to_image(cub->mlx, "wall_4.xpm", \
...
void	init_imagespartone(t_cub *cub)
{
	...
	cub->image[2].arr = ft_mem2array((uint32_t *)cub->image[2].addr, \
		1920, 1080);
	cub->texture[0].img = mlx_xpm_file_to_image(cub->mlx, "wall_1.xpm", \
